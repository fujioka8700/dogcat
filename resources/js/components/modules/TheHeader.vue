      ...
      <div class="d-flex flex-row justify-content-between align-items-center">
        <div class="wrapper pt-3 pb-3">
          ...
          >
            ...
            <h1 class="header-logo ms-1 text-black">DogCat</h1>
          </router-link>
        </div>
        <div>
          <div class="d-none d-sm-block">
            <ul class="nav">
              <li class="nav-item">
                <router-link :to="{ name: 'about' }" class="nav-link nav-link__color">
                  Ureshitterとは
                </router-link>
              </li>
              <li class="nav-item">
                <a
                  ...
                  href="https://twitter.com/fujioka8700"
                  target="_blank"
                >
                  twitter
                  <img
              ...
              <li class="nav-item">
                <a
                  class="nav-link nav-link__color"
                  href="https://github.com/fujioka8700/ureshitter"
                  target="_blank"
                >
                  GitHub
                  <img
